...
public class ExtraHoteleros extends Alojamiento{
    ...
    public ExtraHoteleros() {    //agregamos el super();
        super();
    }

    public ExtraHoteleros(Boolean privado, Integer mts2) {    //propio de esta clase y uno con super y atributos heredados
        this.privado = privado;
        this.mts2 = mts2;
    }

    public ExtraHoteleros(Boolean privado, Integer mts2, String nombreAlojamiento, String direccion, String localidad, String gerente) {
        super(nombreAlojamiento, direccion, localidad, gerente);
        this.privado = privado;
        this.mts2 = mts2;
    }

    public Boolean getPrivado() {    //respectivos setter y getter de los atributos de ésta clase
        return privado;
    }
    ...
    public String toString() {
        return "SECCION EXTRA DE HOTELES"+"\n"
              +"Es privado? -> "+privado+"\n"
              +"Metros cuadrados: "+mts2;
    }
