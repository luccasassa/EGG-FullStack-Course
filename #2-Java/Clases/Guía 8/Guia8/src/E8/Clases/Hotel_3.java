...
public class Hotel_3 extends Alojamiento{    //hereda unicamente de la clase abuelo, no hay padre de por medio
    ...
    public Hotel_3() {    //agregar super();
        super();
    }

    public Hotel_3(Integer cantHabitaciones, Integer cantCamas, Integer pisos, Integer precioHabitacion) {
    ...
    public Hotel_3(Integer cantHabitaciones, Integer cantCamas, Integer pisos, Integer precioHabitacion, String nombreAlojamiento, String direccion, String localidad, String gerente) {
        super(nombreAlojamiento, direccion, localidad, gerente);
        this.cantHabitaciones = cantHabitaciones;
        this.cantCamas = cantCamas;
        this.pisos = pisos;
        this.precioHabitacion = precioHabitacion;
    ...
    public Integer calcularPrecioHabitacion(){
        precioHabitacion = 50 + (1 * cantCamas);
