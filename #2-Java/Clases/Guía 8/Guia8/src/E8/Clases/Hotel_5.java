...
public class Hotel_5 extends Hotel_4 {
    ...
    public Hotel_5(Integer cantSalones, Integer cantSuites, Integer cantLimosinas) {
        this.cantSalones = cantSalones;
        this.cantSuites = cantSuites;
        this.cantLimosinas = cantLimosinas;
    }

    public Hotel_5(Integer cantSalones, Integer cantSuites, Integer cantLimosinas, String gym, String nombreRestaurante, Integer capRestaurante) {
        super(gym, nombreRestaurante, capRestaurante);
        this.cantSalones = cantSalones;
        this.cantSuites = cantSuites;
        this.cantLimosinas = cantLimosinas;
    }

    public Hotel_5(Integer cantSalones, Integer cantSuites, Integer cantLimosinas, String gym, String nombreRestaurante, Integer capRestaurante, Integer cantHabitaciones, Integer cantCamas, Integer pisos, Integer precioHabitacion) {
        super(gym, nombreRestaurante, capRestaurante, cantHabitaciones, cantCamas, pisos, precioHabitacion);
        this.cantSalones = cantSalones;
        this.cantSuites = cantSuites;
        this.cantLimosinas = cantLimosinas;
    }

    public Hotel_5(Integer cantSalones, Integer cantSuites, Integer cantLimosinas, String gym, String nombreRestaurante, Integer capRestaurante, Integer cantHabitaciones, Integer cantCamas, Integer pisos, Integer precioHabitacion, String nombreAlojamiento, String direccion, String localidad, String gerente) {
        super(gym, nombreRestaurante, capRestaurante, cantHabitaciones, cantCamas, pisos, precioHabitacion, nombreAlojamiento, direccion, localidad, gerente);
        this.cantSalones = cantSalones;
        this.cantSuites = cantSuites;
        this.cantLimosinas = cantLimosinas;
    }
    ...
    public Integer calcularPrecioHab() {
        precioHabitacion = 50 + (1 * cantCamas) + valorAgregadoRestaurante() + valorAgregadoGym() + (cantLimosinas * 15);
        return precioHabitacion;
    }

    @Override
    public String toString() {
        return "\nTERCERA SECCION DE HOTELES"+"\n"
              +"Cantidad de salones: "+cantSalones+"\n"
