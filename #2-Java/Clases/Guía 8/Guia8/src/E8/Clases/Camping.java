...
public class Camping extends ExtraHoteleros{
    ...
    protected Integer capBathrooms;
    ...
    public Camping(Integer capMaxCarpas, Integer capBathrooms, Boolean restaurante) {    //respectivo constructor con los atributos de ésta clase
        this.capMaxCarpas = capMaxCarpas;
        this.capBathrooms = capBathrooms;
        this.restaurante = restaurante;
    }

    public Camping(Integer capMaxCarpas, Integer capBathrooms, Boolean restaurante, Boolean privado, Integer mts2) {    //constructor sumado atributos padre
        super(privado, mts2);
        this.capMaxCarpas = capMaxCarpas;
        this.capBathrooms = capBathrooms;
        this.restaurante = restaurante;
    ...
    public Camping(Integer capMaxCarpas, Integer capBathrooms, Boolean restaurante, Boolean privado, Integer mts2, String nombreAlojamiento, String direccion, String localidad, String gerente) {
        super(privado, mts2, nombreAlojamiento, direccion, localidad, gerente);
        this.capMaxCarpas = capMaxCarpas;
        this.capBathrooms = capBathrooms;
        this.restaurante = restaurante;    //constructor sumado atributos abuelo
    }
    ...
    public Integer getCapBathrooms() {
        return capBathrooms;
    }

    public void setCapBathrooms(Integer capBathrooms) {
        this.capBathrooms = capBathrooms;
    }
    ...
    public String toString() {
        return "\nSECCION CAMPING"+"\n"
              +"Capacidad máxima de carpas: "+capMaxCarpas+"\n"
              +"Capacidad de baños: "+capBathrooms+"\n"
