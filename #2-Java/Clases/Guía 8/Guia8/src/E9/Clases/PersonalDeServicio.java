...
public class PersonalDeServicio extends Empleado{
    ...
    public PersonalDeServicio(String seccion, Integer anioIncorporacion, Integer numDespacho) {
        super(anioIncorporacion, numDespacho);
        this.seccion = seccion;
    }
    
    public PersonalDeServicio(String seccion, Integer anioIncorporacion, Integer numDespacho, String nombreYapellido, Integer id, String estadoCivil) {
        super(anioIncorporacion, numDespacho, nombreYapellido, id, estadoCivil);
        this.seccion = seccion;
    }
    ...
    public void trasladoDeSeccion(){
        System.out.print("Ingrese la nueva sección del personal de servicio -> ");
        seccion = sc.next();
    }
