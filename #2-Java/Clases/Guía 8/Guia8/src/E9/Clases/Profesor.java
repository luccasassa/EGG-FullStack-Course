...
public class Profesor extends Empleado{
    ...
    public Profesor(String departamento, Integer anioIncorporacion, Integer numDespacho) {
        super(anioIncorporacion, numDespacho);
        this.departamento = departamento;
    }

    public Profesor(String departamento, Integer anioIncorporacion, Integer numDespacho, String nombreYapellido, Integer id, String estadoCivil) {
    ...
    public void cambioDepartamento(){
        System.out.print("Ingrese el nuevo departamento de profesor -> ");
