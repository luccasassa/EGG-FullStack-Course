...
public class Gato extends Animal{    //clase hija hereda los atributos de la clase padre (se debe crear un constructor de los mismos acá también)
    
    public Gato(String nombre, Integer edad, String raza, String alimento) {    //borrar el constructor vacío y dejar éste
