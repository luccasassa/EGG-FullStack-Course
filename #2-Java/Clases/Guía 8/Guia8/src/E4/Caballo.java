...
public class Caballo extends Animal{    //clase hija hereda los atributos de la clase padre (se debe crear un constructor de los mismos acá también)
    
    public Caballo(String nombre, Integer edad, String raza, String alimento) {    //borrar el constructor vacío y dejar éste
        super(nombre, edad, raza, alimento);    //acá se setea el famoso (this.nombre = nombre) pero de ésta manera!!!
    }
