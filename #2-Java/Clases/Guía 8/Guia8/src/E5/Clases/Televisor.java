...
public class Televisor extends Electrodomestico{
    ...
    //PROCEDO A HACER LO MISMO QUE HICE CON LA CLASE LAVADORA
    ...
    public Televisor(Integer pulgadas, Boolean sintonizadorTDT, Integer precioBase, Integer peso) {    //creo que están de más los ya inicializados (preguntar)
        super(precioBase, peso);
        this.pulgadas = 20;
        this.sintonizadorTDT = false;
    }

    public Televisor(Integer pulgadas, Boolean sintonizadorTDT, Integer precioBase, String color, String consumo, Integer peso) {
