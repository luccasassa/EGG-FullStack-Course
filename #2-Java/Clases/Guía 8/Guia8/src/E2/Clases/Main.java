...
import E2.Service.AsientoService;
import E2.Service.CineService;
import E2.Service.EspectadorService;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Espectador> listafinal = EspectadorService.crearEspectadores();
        
        Pelicula datosPelicula = new Pelicula("EL REGRESO DE SASHA GREY", 96, 18, "BangBros");
        Cine entrada = new Cine(datosPelicula, 200.00);
        
        System.out.println("\n  CINEMARK ®\n"
        +"- Película: "+datosPelicula.getTitulo()+"\n"
        +"- Duración: "+datosPelicula.getDuracion()+" minutos\n"
        +"- Edad Requerida: +"+datosPelicula.getEdadmin()+"\n"
        +"- Director: "+datosPelicula.getDirector());
        
        CineService.venderEntradas(entrada, listafinal);
        System.out.println("");
    }
}
